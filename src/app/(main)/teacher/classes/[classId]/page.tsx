...
export default function ClassDetailsPage() {
    ...
    const filteredStudents = useMemo(() => {
        ...
        // Optimization: Hoist toLowerCase to prevent redundant object allocation in loop
    ...
    const studentStats = useMemo(() => {
        // Optimization: Use Date.now() instead of creating a new Date object
                            ...
                            <TableBody>
                                {filteredStudents.map((student) => {
                                    const daysSinceLogin = student.lastLoginDate
                                        // Optimization: Use Date.now() instead of creating a Date object
