...
export default function ClassesPage() {
  ...
  const uniqueSubjects = useMemo(() => {
    // Bolt: Optimize Set creation by avoiding intermediate array from map
  ...
  const stats = useMemo(() => {
    ...
    // Avoids two separate reduce iterations over classes array
    let totalStudents = 0;
    let mostPopularClass = classes[0];
    let maxStudents = classes[0]?.studentIds?.length || 0;
