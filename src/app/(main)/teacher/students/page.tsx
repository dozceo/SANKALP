...
const isActive = (lastActivity?: Date): boolean => {
    ...
    // Optimization: Use Date.now() instead of new Date().getTime() to prevent object allocation
...
export default function StudentsPage() {
    ...
    const stats = useMemo(() => {
        ...
        // Optimization: Consolidate multiple O(N) array passes (.filter and .reduce) into a single loop
