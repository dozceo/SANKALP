...
export function StudyLibrary() {
    ...
    const subjects = useMemo(() => {
        // ⚡ Bolt: Use a single pass loop instead of map() to avoid O(N) array allocation overhead
    ...
    const filteredMaterials = useMemo(() => {
        // ⚡ Bolt: Hoist toLowerCase() computation outside the filter loop to prevent redundant string allocation
