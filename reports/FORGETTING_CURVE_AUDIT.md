# Forgetting Curve Model Implementation Audit
...
- ❌ **MISSING LOGIC**: The inference script `predict_mastery.py` does **not** contain logic for `days_until_forget`. It only predicts mastery probability.
