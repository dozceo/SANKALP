...
|---|---|---|---|
| src/app/api/chaos/route.ts | 47 | name | `name: 'Chaos Student',` |
| src/app/api/chaos/route.ts | 48 | email | `email: 'chaos@example.com',` |
...
| src/lib/db-helpers.ts | 17 | uid | `uid: string;` |
| src/lib/db-helpers.ts | 18 | email | `email: string;` |
| src/lib/db-helpers.ts | 19 | name | `name: string;` |
| src/lib/db-helpers.ts | 29 | name | `name: string;` |
| src/lib/db-helpers.ts | 30 | email | `email: string;` |
| src/lib/db-helpers.ts | 53 | email | `email: string;` |
| src/lib/db-helpers.ts | 54 | name | `name: string;` |
| src/lib/db-helpers.ts | 316 | email | `email: data?.email  '',` |
| src/lib/db-helpers.ts | 317 | name | `name: data?.name  '',` |
| src/lib/db-helpers.ts | 342 | email | `email: string;` |
| src/lib/db-helpers.ts | 343 | name | `name: string;` |
| src/lib/db-helpers.ts | 356 | email | `email: student.email,` |
